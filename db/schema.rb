...
ActiveRecord::Schema[7.0].define(version: 2022_07_18_044057) do
  ...
  create_table "product_packs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_product_packs_on_product_id"
  end
  ...
  add_foreign_key "product_packs", "products"
end
